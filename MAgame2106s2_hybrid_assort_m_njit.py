# implements the main hybrid model with learned partner stay/switch decisions
# combines q-learning for pd behaviour and partner switching with assortative rematching
...
def run_experiment_batch(
    ...
    for simulation in range(simStart, Nsim + 1):
        ...
        print(
            f"Completed: hybrid, sim={simulation}, m={m:.2f}"
        )
